...
# --- Config ---
AUDIO_FILE = "B.wav"
AUDIO_DIR = "aaron_xai4ae/approach_3/works/guitar_chords_modulation/guitar_chord_dataset/"
OUTPUT_DIR = "aaron_xai4ae/approach_3/works/guitar_chords_modulation/results"
...
def resample_audio(path):
    ...
    if waveform.shape[0] > 1:  # More than 1 channel (e.g., stereo)
...
def main():
    ...
    for TARGET_SHIFT in pr:
        ...
        file_stub = f"{AUDIO_FILE}_shift_{TARGET_SHIFT}"
